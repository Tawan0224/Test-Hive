      ...
      <main className="relative z-10 pt-20 sm:pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12">
            <div className={`inline-flex items-center gap-2 px-4 sm:px-6 py-2 rounded-full ${performance.bg} mb-4 sm:mb-6`}>
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3 font-display">Quiz Complete!</h1>
            <p className="text-white/60 font-body">{quizData.title}</p>
          </div>

          {/* Score Card */}
          <div className="bg-dark-600/80 backdrop-blur-xl rounded-3xl border border-hive-purple/20 p-4 sm:p-8 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-8">
              ...
              <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div className="bg-dark-500/50 rounded-2xl p-4 sm:p-5 flex items-center gap-4">
